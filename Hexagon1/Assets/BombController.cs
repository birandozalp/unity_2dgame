...
public class BombController : MonoBehaviour
{
    ...
    void Start()
    {
        countDown = ClickManager.turnCounter + 5;
    }
    ...
    {
        if(countDown == ClickManager.turnCounter)
        {
            GameObject gameOver = Instantiate(gover, new Vector3(3, 3, 1), Quaternion.identity);
    ...
    public void cleanSelection()
    {
        if (ClickManager.tempGO1 != null)
            ClickManager.tempGO1.GetComponent<SpriteRenderer>().sprite = ClickManager.unsBomb.GetComponent<SpriteRenderer>().sprite;
        if (ClickManager.tempGO2 != null)
            ClickManager.tempGO2.GetComponent<SpriteRenderer>().sprite = ClickManager.unsBomb.GetComponent<SpriteRenderer>().sprite;
        if (ClickManager.tempGO3 != null)
            ClickManager.tempGO3.GetComponent<SpriteRenderer>().sprite = ClickManager.unsBomb.GetComponent<SpriteRenderer>().sprite;
    }
    ...
    {
        HexagonController.score += 20;
        if (HexagonController.score % 1000 == 0)
        {
